...
let
  ...
  data2 =
    if builtins.isFunction data then
      ...
      throw "importing '${builtins.typeOf data}' from ${toString path} is not supported";
  ...
  snapshot =
    let
      ...
      drvs = builtins.concatStringsSep "" (builtins.attrValues (builtins.mapAttrs toNixDrv data2));
